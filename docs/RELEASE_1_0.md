...
Depot is currently `0.13.0-preview` with database schema version **29**. Checked implementation items below mean code exists on `master`; they do not replace the outstanding release verification.
