...
| **Accounts Payable** | Supplier invoices and PO/receipt/invoice matching | Supplier-invoice approval, Treasury and General Ledger administration |
...
- Supplier-invoice approval is not part of Accounts Payable; use the existing **Approver** role when that authority is required.
