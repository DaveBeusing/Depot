...
{
	private const string Columns = "sh.Id,sh.ShipmentNumber,sh.SalesOrderId,so.OrderNumber,sh.CustomerId,c.Name,sh.ShipmentDate,sh.Status,sh.Carrier,sh.TrackingNumber,sh.ShippingAddress,sh.Notes,sh.CreatedByUserId,sh.PostedByUserId,sh.PostedAtUtc,sh.Version";
