...
public sealed class WorkspaceProductivityViewModel : BaseViewModel
{
	...
	[
		...
		"role-centers.treasury-workspace",
		"role-centers.accounting-control-workspace",
		"role-centers.management-cockpit",
		"role-centers.audit-compliance",
		"role-centers.master-data",
		"role-centers.application-administration",
		"inventory.items",
