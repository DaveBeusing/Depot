...
public static class SystemRoleCatalog
{
	...
	[
		...
		new(PurchasingCode, "Purchasing", "Creates and manages suppliers, requisitions, sourcing and purchase orders.", Union(CommonViewPermissions, ApplicationPermission.PurchasingView, ApplicationPermission.PurchaseOrdersView, ApplicationPermission.PurchaseOrdersCreate, ApplicationPermission.PurchaseOrdersEdit, ApplicationPermission.PurchaseOrdersSubmit, ApplicationPermission.PurchaseOrdersOrder, ApplicationPermission.PurchaseOrdersClose, ApplicationPermission.PurchaseRequisitionsView, ApplicationPermission.PurchaseRequisitionsManage, ApplicationPermission.SupplierSourcingView, ApplicationPermission.SupplierSourcingManage, ApplicationPermission.SupplierSourcingConvert, ApplicationPermission.SuppliersView, ApplicationPermission.SuppliersManage, ApplicationPermission.GoodsReceiptsView, ApplicationPermission.SupplierReturnsView, ApplicationPermission.ProjectsView, ApplicationPermission.ProjectAttributionsManage)),
		new(ApproverCode, "Approver", "Reviews purchase requisitions, purchase orders, supplier invoices and payment proposals while preserving creator/approver separation.", Union(CommonViewPermissions, ApplicationPermission.PurchaseRequisitionsView, ApplicationPermission.PurchaseRequisitionsApprove, ApplicationPermission.PurchaseOrdersView, ApplicationPermission.PurchaseOrdersApprove, ApplicationPermission.FinancePayablesView, ApplicationPermission.FinanceSupplierInvoicesApprove, ApplicationPermission.FinanceSupplierMatchExceptionsApprove, ApplicationPermission.FinanceBankingView, ApplicationPermission.FinancePaymentProposalsApprove, ApplicationPermission.FinanceBudgetingView, ApplicationPermission.FinanceBudgetingApprove)),
		new(WarehouseOperatorCode, "Warehouse Operator", "Operates warehouse documents and stock workflows.", Union(CommonViewPermissions, ApplicationPermission.PurchasingView, ApplicationPermission.InventoryManage, ApplicationPermission.StockMovementsCreate, ApplicationPermission.StockMovementsPost, ApplicationPermission.StockMovementsReverse, ApplicationPermission.StockTransfersCreate, ApplicationPermission.StockTransfersEdit, ApplicationPermission.StockTransfersPost, ApplicationPermission.StockTransfersReverse, ApplicationPermission.InventoryCountsCreate, ApplicationPermission.InventoryCountsEdit, ApplicationPermission.InventoryCountsPost, ApplicationPermission.InventoryCountsReverse, ApplicationPermission.GoodsReceiptsView, ApplicationPermission.GoodsReceiptsCreate, ApplicationPermission.GoodsReceiptsPost, ApplicationPermission.GoodsReceiptsReverse, ApplicationPermission.MaterialIssuesView, ApplicationPermission.MaterialIssuesCreate, ApplicationPermission.MaterialIssuesEdit, ApplicationPermission.MaterialIssuesPost, ApplicationPermission.MaterialIssuesReverse, ApplicationPermission.MaterialReturnsView, ApplicationPermission.MaterialReturnsCreate, ApplicationPermission.MaterialReturnsEdit, ApplicationPermission.MaterialReturnsPost, ApplicationPermission.MaterialReturnsReverse, ApplicationPermission.SupplierReturnsView, ApplicationPermission.SupplierReturnsCreate, ApplicationPermission.SupplierReturnsEdit, ApplicationPermission.SupplierReturnsPost, ApplicationPermission.SupplierReturnsReverse, ApplicationPermission.SalesView, ApplicationPermission.SalesOrdersView, ApplicationPermission.ShipmentsView, ApplicationPermission.ShipmentsCreate, ApplicationPermission.ShipmentsEdit, ApplicationPermission.ShipmentsPost, ApplicationPermission.ShipmentsReverse, ApplicationPermission.CustomerReturnsView, ApplicationPermission.CustomerReturnsCreate, ApplicationPermission.CustomerReturnsPost, ApplicationPermission.ProductionView, ApplicationPermission.BillsOfMaterialManage, ApplicationPermission.ProductionOrdersManage, ApplicationPermission.ProductionOrdersIssue, ApplicationPermission.ProductionOrdersComplete, ApplicationPermission.ProductionOrdersReverse)),
		new(SalesUserCode, "Sales User", "Creates customer records, leads, opportunities, activities, quotes and sales orders and submits them for approval.", Union(CommonViewPermissions, ApplicationPermission.SalesView, ApplicationPermission.CustomersView, ApplicationPermission.CustomersCreate, ApplicationPermission.CustomersEdit, ApplicationPermission.SalesCrmView, ApplicationPermission.SalesCrmRecordsManage, ApplicationPermission.SalesCrmActivitiesView, ApplicationPermission.SalesCrmActivitiesManage, ApplicationPermission.SalesQuotesView, ApplicationPermission.SalesQuotesCreate, ApplicationPermission.SalesQuotesEdit, ApplicationPermission.SalesQuotesSend, ApplicationPermission.SalesQuotesConvert, ApplicationPermission.SalesPricingView, ApplicationPermission.SubscriptionContractsView, ApplicationPermission.SubscriptionContractsManage, ApplicationPermission.ServiceManagementView, ApplicationPermission.ServiceCasesManage, ApplicationPermission.SalesOrdersView, ApplicationPermission.SalesOrdersCreate, ApplicationPermission.SalesOrdersEdit, ApplicationPermission.SalesOrdersSubmit, ApplicationPermission.ProjectsView, ApplicationPermission.ProjectAttributionsManage)),
		new(SalesManagerCode, "Sales Manager", "Manages CRM ownership and stages, quotes and pricing, and approves and releases sales orders.", Union(CommonViewPermissions, ApplicationPermission.SalesView, ApplicationPermission.CustomersView, ApplicationPermission.CustomersCreate, ApplicationPermission.CustomersEdit, ApplicationPermission.SalesCrmView, ApplicationPermission.SalesCrmRecordsManage, ApplicationPermission.SalesCrmManage, ApplicationPermission.SalesCrmActivitiesView, ApplicationPermission.SalesCrmActivitiesManage, ApplicationPermission.SalesQuotesView, ApplicationPermission.SalesQuotesCreate, ApplicationPermission.SalesQuotesEdit, ApplicationPermission.SalesQuotesSend, ApplicationPermission.SalesQuotesConvert, ApplicationPermission.SalesPricingView, ApplicationPermission.SalesPricingManage, ApplicationPermission.SubscriptionContractsView, ApplicationPermission.SubscriptionContractsManage, ApplicationPermission.ServiceManagementView, ApplicationPermission.ServiceCasesManage, ApplicationPermission.ServiceOrdersManage, ApplicationPermission.ServiceOrdersClose, ApplicationPermission.SalesOrdersView, ApplicationPermission.SalesOrdersCreate, ApplicationPermission.SalesOrdersEdit, ApplicationPermission.SalesOrdersSubmit, ApplicationPermission.SalesOrdersApprove, ApplicationPermission.SalesOrdersRelease, ApplicationPermission.SalesOrdersCancel, ApplicationPermission.ShipmentsView, ApplicationPermission.CustomerReturnsView, ApplicationPermission.SalesInvoicesView, ApplicationPermission.CreditNotesView, ApplicationPermission.ProjectsView, ApplicationPermission.ProjectsManage, ApplicationPermission.ProjectAttributionsManage, ApplicationPermission.ProjectFinancialsView)),
		new(FinanceCode, "Finance", "Manages financial documents, inventory accounting, banking, reporting, localization, subledgers, Finance configuration and controlled General Ledger posting.", Union(CommonViewPermissions,
			...
			ApplicationPermission.SubscriptionContractsView, ApplicationPermission.SubscriptionBillingGenerate, ApplicationPermission.ServiceManagementView, ApplicationPermission.ServiceBillingGenerate, ApplicationPermission.SalesInvoicesView, ApplicationPermission.SalesInvoicesCreate, ApplicationPermission.SalesInvoicesPost, ApplicationPermission.CreditNotesView, ApplicationPermission.CreditNotesCreate, ApplicationPermission.CreditNotesPost,
			...
			ApplicationPermission.ProjectsView, ApplicationPermission.ProjectsManage, ApplicationPermission.ProjectAttributionsManage, ApplicationPermission.ProjectFinancialsView)),
		...
		new(AccountsReceivableCode, "Accounts Receivable", "Operates customer open items, receipts, allocations and dunning without Accounts Payable, Banking or General Ledger administration.", Set(
			...
			ApplicationPermission.FinanceDunningView, ApplicationPermission.FinanceDunningManage, ApplicationPermission.ProjectsView, ApplicationPermission.ProjectFinancialsView)),
		new(AccountsPayableCode, "Accounts Payable", "Processes supplier invoices and matching while keeping invoice approval and Treasury authority separate.", Set(
			...
			ApplicationPermission.FinanceSupplierInvoicesPost, ApplicationPermission.FinanceSupplierInvoicesReverse, ApplicationPermission.ProjectsView, ApplicationPermission.ProjectAttributionsManage)),
