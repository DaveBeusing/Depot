...
public static class SystemRoleCatalog
{
	...
	[
		...
		new(ApproverCode, "Approver", "Reviews purchase orders, supplier invoices and payment proposals while preserving creator/approver separation.", Union(CommonViewPermissions,
			ApplicationPermission.PurchaseOrdersView, ApplicationPermission.PurchaseOrdersApprove,
			ApplicationPermission.FinancePayablesView, ApplicationPermission.FinanceSupplierInvoicesApprove,
			ApplicationPermission.FinanceBankingView, ApplicationPermission.FinancePaymentProposalsApprove)),
		...
		new(FinanceCode, "Finance", "Manages customer and supplier financial documents, inventory accounting, banking, Accounts Receivable, Accounts Payable, Finance configuration and controlled General Ledger posting.", Union(CommonViewPermissions,
			ApplicationPermission.SalesView,
			...
			ApplicationPermission.FinancePayablesView, ApplicationPermission.FinancePayablesManage,
			ApplicationPermission.FinanceSupplierInvoicesCreate, ApplicationPermission.FinanceSupplierInvoicesSubmit,
			ApplicationPermission.FinanceSupplierInvoicesPost, ApplicationPermission.FinanceSupplierInvoicesReverse,
			ApplicationPermission.FinancePayablePaymentsPost, ApplicationPermission.FinancePayablePaymentsReverse,
			ApplicationPermission.FinanceInventoryAccountingView, ApplicationPermission.FinanceInventoryAccountingManage,
			ApplicationPermission.FinanceBankingView, ApplicationPermission.FinanceBankingManage,
			ApplicationPermission.FinanceBankStatementsCreate, ApplicationPermission.FinanceBankReconciliationManage,
			ApplicationPermission.FinancePaymentProposalsCreate, ApplicationPermission.FinancePaymentRunsPost,
