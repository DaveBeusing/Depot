...
public sealed class SqlServerConnectionFactory : IDatabaseConnectionFactory
{
	...
	public string GetInventoryCountLockSql() =>
		"SELECT Id FROM InventoryCounts WITH (UPDLOCK, HOLDLOCK) WHERE Id = $InventoryCountId;";
	...
	public string GetSupplierReturnLockSql() =>
		"SELECT Id FROM SupplierReturns WITH (UPDLOCK, HOLDLOCK) WHERE Id = $SupplierReturnId;";
