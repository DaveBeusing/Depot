...
internal static class FinanceBudgetingSchemaInitializer
{
	...
	[
		"CREATE TABLE IF NOT EXISTS FinanceBudgetVersions (Id TEXT NOT NULL PRIMARY KEY,Version INTEGER NOT NULL DEFAULT 1,LegalEntityId TEXT NOT NULL,AccountingBookId TEXT NOT NULL,FiscalCalendarId TEXT NOT NULL,FiscalYear INTEGER NOT NULL,BudgetName TEXT NOT NULL,BudgetVersionNumber INTEGER NOT NULL,CurrencyCode TEXT NOT NULL,Status INTEGER NOT NULL,OwnerUserId INTEGER NOT NULL,Description TEXT NULL,SourceKind INTEGER NOT NULL,SourceBudgetVersionId TEXT NULL,ApprovalInstanceId TEXT NULL,CreatedAtUtc TEXT NOT NULL,CreatedByUserId INTEGER NOT NULL,UpdatedAtUtc TEXT NOT NULL,UpdatedByUserId INTEGER NOT NULL,UNIQUE(LegalEntityId,AccountingBookId,FiscalYear,BudgetName,BudgetVersionNumber));",
		...
		"CREATE TABLE IF NOT EXISTS FinanceBudgetLines (Id INTEGER PRIMARY KEY AUTOINCREMENT,Version INTEGER NOT NULL DEFAULT 1,BudgetVersionId TEXT NOT NULL,AccountId TEXT NOT NULL,AccountingPeriodId TEXT NOT NULL,DimensionId TEXT NOT NULL DEFAULT '',DimensionValueId TEXT NOT NULL DEFAULT '',Amount NUMERIC NOT NULL,SourceEvidence TEXT NULL,UNIQUE(BudgetVersionId,AccountId,AccountingPeriodId,DimensionId,DimensionValueId));",
	...
	[
		...
		"IF OBJECT_ID(N'FinanceBudgetLines',N'U') IS NULL CREATE TABLE FinanceBudgetLines (Id bigint IDENTITY(1,1) NOT NULL PRIMARY KEY,Version bigint NOT NULL CONSTRAINT DF_FinanceBudgetLines_Version DEFAULT 1,BudgetVersionId nvarchar(36) NOT NULL,AccountId nvarchar(36) NOT NULL,AccountingPeriodId nvarchar(36) NOT NULL,DimensionId nvarchar(36) NOT NULL CONSTRAINT DF_FinanceBudgetLines_DimensionId DEFAULT '',DimensionValueId nvarchar(36) NOT NULL CONSTRAINT DF_FinanceBudgetLines_DimensionValueId DEFAULT '',Amount decimal(28,9) NOT NULL,SourceEvidence nvarchar(500) NULL,CONSTRAINT UQ_FinanceBudgetLines UNIQUE(BudgetVersionId,AccountId,AccountingPeriodId,DimensionId,DimensionValueId));",
	...
	[
		"CREATE TABLE IF NOT EXISTS FinanceBudgetVersions (Id VARCHAR(36) NOT NULL PRIMARY KEY,Version BIGINT NOT NULL DEFAULT 1,LegalEntityId VARCHAR(36) NOT NULL,AccountingBookId VARCHAR(36) NOT NULL,FiscalCalendarId VARCHAR(36) NOT NULL,FiscalYear INT NOT NULL,BudgetName VARCHAR(200) NOT NULL,BudgetVersionNumber INT NOT NULL,CurrencyCode VARCHAR(3) NOT NULL,Status INT NOT NULL,OwnerUserId BIGINT NOT NULL,Description VARCHAR(1000) NULL,SourceKind INT NOT NULL,SourceBudgetVersionId VARCHAR(36) NULL,ApprovalInstanceId VARCHAR(36) NULL,CreatedAtUtc DATETIME(6) NOT NULL,CreatedByUserId BIGINT NOT NULL,UpdatedAtUtc DATETIME(6) NOT NULL,UpdatedByUserId BIGINT NOT NULL,UNIQUE KEY UQ_FinanceBudgetVersions (LegalEntityId,AccountingBookId,FiscalYear,BudgetName,BudgetVersionNumber),INDEX IX_FinanceBudgetVersions_List (LegalEntityId,AccountingBookId,FiscalYear,Status,BudgetName,BudgetVersionNumber));",
		"CREATE TABLE IF NOT EXISTS FinanceBudgetLines (Id BIGINT NOT NULL AUTO_INCREMENT PRIMARY KEY,Version BIGINT NOT NULL DEFAULT 1,BudgetVersionId VARCHAR(36) NOT NULL,AccountId VARCHAR(36) NOT NULL,AccountingPeriodId VARCHAR(36) NOT NULL,DimensionId VARCHAR(36) NOT NULL DEFAULT '',DimensionValueId VARCHAR(36) NOT NULL DEFAULT '',Amount DECIMAL(28,9) NOT NULL,SourceEvidence VARCHAR(500) NULL,UNIQUE KEY UQ_FinanceBudgetLines (BudgetVersionId,AccountId,AccountingPeriodId,DimensionId,DimensionValueId),INDEX IX_FinanceBudgetLines_Aggregate (BudgetVersionId,AccountingPeriodId,AccountId,DimensionId,DimensionValueId));"
	];
}
