...
internal static class FinanceFixedAssetsSchemaInitializer
{
	...
	private static readonly string[] Local=[
		"CREATE TABLE IF NOT EXISTS FinanceAssetClasses (Id INTEGER PRIMARY KEY AUTOINCREMENT,Version INTEGER NOT NULL DEFAULT 1,LegalEntityId TEXT NOT NULL,FiscalCalendarId TEXT NOT NULL,Code TEXT NOT NULL,Name TEXT NOT NULL,CapitalizationPostingProfileId INTEGER NOT NULL,DepreciationPostingProfileId INTEGER NOT NULL,ImpairmentPostingProfileId INTEGER NOT NULL,DisposalPostingProfileId INTEGER NOT NULL,DefaultUsefulLifeMonths INTEGER NOT NULL,DefaultMethod INTEGER NOT NULL,IsActive INTEGER NOT NULL,UNIQUE(LegalEntityId,Code));",
	...
	private static readonly string[] SqlServer=[
		"IF OBJECT_ID(N'FinanceAssetClasses',N'U') IS NULL CREATE TABLE FinanceAssetClasses (Id bigint IDENTITY(1,1) PRIMARY KEY,Version bigint NOT NULL DEFAULT 1,LegalEntityId nvarchar(36) NOT NULL,FiscalCalendarId nvarchar(36) NOT NULL,Code nvarchar(50) NOT NULL,Name nvarchar(200) NOT NULL,CapitalizationPostingProfileId bigint NOT NULL,DepreciationPostingProfileId bigint NOT NULL,ImpairmentPostingProfileId bigint NOT NULL,DisposalPostingProfileId bigint NOT NULL,DefaultUsefulLifeMonths int NOT NULL,DefaultMethod int NOT NULL,IsActive bit NOT NULL,CONSTRAINT UQ_FinanceAssetClasses UNIQUE(LegalEntityId,Code));",
		...
		"IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name=N'IX_FinanceAssetDepreciationPeriods_Run' AND object_id=OBJECT_ID(N'FinanceAssetDepreciationPeriods')) CREATE INDEX IX_FinanceAssetDepreciationPeriods_Run ON FinanceAssetDepreciationPeriods (AccountingPeriodId,JournalEntryId,AssetId);",
		...
		"IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name=N'IX_FinanceAssetTransactions_Asset' AND object_id=OBJECT_ID(N'FinanceAssetTransactions')) CREATE INDEX IX_FinanceAssetTransactions_Asset ON FinanceAssetTransactions (AssetId,TransactionDate,Id);"
	];
	private static readonly string[] MySql=[
		"CREATE TABLE IF NOT EXISTS FinanceAssetClasses (Id BIGINT NOT NULL AUTO_INCREMENT PRIMARY KEY,Version BIGINT NOT NULL DEFAULT 1,LegalEntityId VARCHAR(36) NOT NULL,FiscalCalendarId VARCHAR(36) NOT NULL,Code VARCHAR(50) NOT NULL,Name VARCHAR(200) NOT NULL,CapitalizationPostingProfileId BIGINT NOT NULL,DepreciationPostingProfileId BIGINT NOT NULL,ImpairmentPostingProfileId BIGINT NOT NULL,DisposalPostingProfileId BIGINT NOT NULL,DefaultUsefulLifeMonths INT NOT NULL,DefaultMethod INT NOT NULL,IsActive BOOLEAN NOT NULL,UNIQUE KEY UQ_FinanceAssetClasses (LegalEntityId,Code));",
